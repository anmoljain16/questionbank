        ...
        <section className="bg-white">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    ...
                    <Link href="https://www.instagram.com/anmoljain_01/" className="text-gray-400 hover:text-gray-500">
                    ...
                    <Link href="https://twitter.com/AnmolJain_01" className="text-gray-400 hover:text-gray-500">
