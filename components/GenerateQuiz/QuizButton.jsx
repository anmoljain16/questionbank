...
export default function QuizButton() {
    ...
    return(<>
        ...
        onClick={openCreateQuizModal}
                    className="flex items-center hover:scale-105 duration-100  flex-shrink-0 px-5 py-3 space-x-2 border-b focus:border-b-0 focus:rounded-t-lg focus:border  dark:border-gray-600 dark:text-gray-600">
